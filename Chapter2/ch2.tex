...
\begin{table}[htbp]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{LLLLLL}
		...
		Nano-porous & Knudsen diffusion, Poiseuille flow, Capillary condensation, Surface diffusion, Molecular sieving & Brittle & Good\cite{Ockwig2007} & Ambient -500\textdegree C & 2.4 \cite{Lee2007} -  1000 \textbf{ref for this}
        (H\textsubscript{2}/N\textsubscript{2} selectivity)
         \\

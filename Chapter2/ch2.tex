...
\begin{table}[htbp]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{LLLLLL}
		\hline
		\textbf{Material} & \textbf{Separation mechanism} & \textbf{Mechanical stability} & \textbf{Chemic3al Stability} & \textbf{Operating temperature} & \textbf{Selectivity} \\ \hline
        ...
        & Negative interaction with CO, CH4, and H2O. Reacts with H2S and SOx 14 & 300-600 15 &  - \\ 
        Dense Ceramic & Solution Diffusion & Brittle
        Difficult to seal due to high operating temperature
         & Degrades under CO2 16 & 500-1000 16
         &  - \\ \hline
	\end{tabular}}
\end{table}

...
\begin{table}[]
    ...
    \begin{table}[]
        ...
        Kr       & 1.1                                                                 \\
        H\textsubscript{2}S      & 0.41                                                                \\
        OCS      & 0.42                                                                \\
        CS\textsubscript{2}      & 0.362                                                               \\
        t-BuSH   & 0.391                                                               \\
        THT      & 0.409                                                               \\
        H\textsubscript{2}       & Balance                                                             \\ \bottomrule
        \end{tabular}
